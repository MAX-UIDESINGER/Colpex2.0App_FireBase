...
import com.example.colpex20app_firebase.Adactadores.Adacter_JefeProducion.AdacterTrabajoJefe.DesgomadoAdacter_jefe;
...
public class FragmentDesgomadoTrabajo_jefe extends Fragment implements RvItemClick {
    // texview Desgomado
    ...
    DesgomadoAdacter_jefe adapter;
    ArrayList<ClaseDesgomado> VersionList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_desgomado_trabajo_jefe, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //FireBase
        IniciarFirebase();
        ListarDatosDesgomado();
        //BadgeDrawablevisible();
    }
    ...
    private void processBuscar(String s) {
        ArrayList<ClaseDesgomado> milistas = new ArrayList<>();
        for (ClaseDesgomado obj : VersionList) {
            if (obj.getNumeroLote().toLowerCase().contains(s.toLowerCase())) {
                ...
                milistas.add(obj);
            } else if (obj.getAcidoFosforico().toLowerCase().contains(s.toLowerCase())) {
                milistas.add(obj);
            } else if (obj.getLoteacido().toLowerCase().contains(s.toLowerCase())) {
                milistas.add(obj);
            } else if (obj.getLoteacido().toLowerCase().contains(s.toLowerCase())) {
                milistas.add(obj);
            } else if (obj.getTempTrabajo().toLowerCase().contains(s.toLowerCase())) {
                milistas.add(obj);
            } else if (obj.getTResidencia().toLowerCase().contains(s.toLowerCase())) {
                milistas.add(obj);
        ...
        DesgomadoAdacter_jefe adacter = new DesgomadoAdacter_jefe(milistas, this);
    ...
    private void inserccion(ClaseDesgomado claseDesgomado) {
        ...
        databaseReference.child("Desgomado").child(claseDesgomado.getId()).setValue(d);
    }

    private void ListarDatosDesgomado() {
        if (!isConnected()) {
            ...
            databaseReference.child("Desgomado").addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        ClaseDesgomado desgomado = dataSnapshot.getValue(ClaseDesgomado.class);
                        progressBar.setVisibility(View.GONE);
                        imgenUp.setVisibility(View.GONE);
                        VersionList.add(desgomado);
                    }
    ...
    private void BadgeDrawableInvisible() {
        BadgeDrawable badgeDrawable = bottomNavigationView.getOrCreateBadge(R.id.nav_trabajadores_op);
        badgeDrawable.clearNumber();
        badgeDrawable.setVisible(false);
    }
    private void BadgeDrawablevisible() {
        bottomNavigationView = getActivity().findViewById(R.id.bottom_nav_menu);
        BadgeDrawable badgenotification = bottomNavigationView.getOrCreateBadge(R.id.nav_trabajadores_op);
    ...
    private void InicioRecyclerview(View view) {
        ...
        //recyclerView.addItemDecoration(DividerItemDecoration(this.getContext(),VersionList));
        adapter = new DesgomadoAdacter_jefe(VersionList, this);
    ...
    private void MetodoDelete(ClaseDesgomado item) {
        ...
        new SweetAlertDialog(getContext(), SweetAlertDialog.ERROR_TYPE)
                ...
                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    ...
                    public void onClick(SweetAlertDialog sDialog) {
                        ...
                        n.setId(item.getId());
                        databaseReference.child("Desgomado").child(n.getId()).removeValue();
    ...
    private void MetodoEditar(ClaseDesgomado item) {
        ...
        sheetDialog.setContentView(R.layout.update_popup_desgomado);
