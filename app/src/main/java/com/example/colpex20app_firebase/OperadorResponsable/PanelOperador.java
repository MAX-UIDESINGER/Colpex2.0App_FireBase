...
public class PanelOperador extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_panel_operador);
        //toolbar
        ToolbarMetodo();
        //navigation
        //  NavigationChipBar();
    ...
    private void NavigationViewmenu() {
        ...
        //   badgeDrawable.setNumber(20000);
        //    badgeDrawable.setVisible(true);
//        String contador = databaseReference.child("Neutralizado").child("").toString();
    //    BadgeDrawable badgenotification = bottomNavigationView.getOrCreateBadge(R.id.nav_trabajadores_op);
    //    badgenotification.setNumber(1);
     //   badgenotification.setVisible(true);

        //  BadgeDrawable badge = bottomNavigationView.getOrCreateBadge(R.id.nav_trabajadores_op);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.nav_trabajadores_op:
                        ...
                        break;
                 //   case R.id.nav_reporte_op:
                   //     navController.navigate(R.id.nav_reporte_op);
                   //     break;
