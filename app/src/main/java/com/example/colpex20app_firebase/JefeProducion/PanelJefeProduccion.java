...
public class PanelJefeProduccion extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_panel_jefe_produccion);
        //toolbar
        ToolbarMetodo();
        //navigation
        NavigationViewmenu();
  ...
  //  public static void Show_Counter(int gconunt_number) {
     //   if (gconunt_number > 0) {
      //      tv_gallery_cunter.setText(gconunt_number + "");
      //  } else {
     //       tv_gallery_cunter.setText("");
     //   }
  //  }
