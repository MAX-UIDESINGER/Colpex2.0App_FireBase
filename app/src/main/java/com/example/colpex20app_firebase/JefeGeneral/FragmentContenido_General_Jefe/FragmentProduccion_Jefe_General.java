...
public class FragmentProduccion_Jefe_General extends Fragment implements ObservacionItem {
    ...
    //EditText
    EditText edtTonelada, edtAcidoFosforico, edtTemperaturaTrabajo, edtTResidencia, edtCantidadBatch, edtObservacion;
    //conexion Firebase
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_produccion__jefe__general, container, false);
    }
    ...
    private void VariablesIngresar(View view) {
        ...
        txtInputobservacion = view.findViewById(R.id.txtInputobservacion);
    }
    ...
    private void llamarMessaje() {
        ...
        try {
            ...
            notificacion.put("titulo", nombreUsuario + " Jefe General");
