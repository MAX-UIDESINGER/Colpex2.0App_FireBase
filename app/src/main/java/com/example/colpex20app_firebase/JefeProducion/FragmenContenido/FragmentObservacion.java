...
import com.example.colpex20app_firebase.Adactadores.Adacter_JefeProducion.LoteAdacter;
...
public class FragmentObservacion extends Fragment implements ObservacionItem, NavigationView.OnNavigationItemSelectedListener {
    //Metodo ArrayList
    LoteAdacter adapter;
    ArrayList<Lote> VersionList;

    LoteAdacter adapterListview;
    ...
    EditText edtTonelada, edtAcidoFosforico, edtTemperaturaTrabajo, edtTResidencia, edtCantidadBatch, Fecha;
    //TooLL bar
    Toolbar toolbar;
    //Progresor bar
    ...
    public static int gallery_count_number = 0;
    public static TextView tv_gallery_cunter;
    ...
    private void processBuscar(String s) {
        ...
        LoteAdacter adacter = new LoteAdacter(milista);
        recyclerView.setAdapter(adacter);
        recyclerViewLisview.setAdapter(adacter);
        adacter.setlListener(new LoteAdacter.ItemClickListener() {
            @Override
    ...
    private void BottonesAdapter() {
        adapter.setlListener(new LoteAdacter.ItemClickListener() {
            @Override
            public void onDeleteItem(Lote Lote) {
                DeleteMetodo(Lote);
            }
        ...
        adapterListview.setlListener(new LoteAdacter.ItemClickListener() {
            @Override
            public void onDeleteItem(Lote Lote) {
                DeleteMetodo(Lote);
            }
    ...
    private void EditMetotodo(Lote lote) {
        ...
        sheetDialog.setContentView(R.layout.update_popup);
    ...
    private void InicioRecyclerview(View view) {
        ...
        //Adapter
        adapter = new LoteAdacter(VersionList);
    ...
    private void InicioRecycleLisView(View view) {
        ...
        //Adapter
        adapterListview = new LoteAdacter(VersionListview);
    ...
    private void NavigationViewmenu() {
        ...
        badgenotification = bottomNavigationView.getOrCreateBadge(R.id.nav_observacion);
    }

    private void NavigationDrawer() {
        navigationView = getActivity().findViewById(R.id.nav_view);
        contentView = getActivity().findViewById(R.id.content);
    ...
    private void BadgeNotification(Lote lote) {
        //    badgenotification.setNumber(Integer.parseInt(lote.getBadgenotification()));
        //   badgenotification.setMaxCharacterCount(3);
        //   badgenotification.setVisible(true);

        //   gallery_count_number = Integer.parseInt(lote.getBadgenotification());
        ...
        //   navigationView.getMenu().findItem(R.id.nav_observacion).setActionView(tv_gallery_cunter);
