...
import com.example.colpex20app_firebase.Adactadores.Adacter_Operador.AdacterLote.LoteCarbonActivoAdacter;
...
public class FragmentCarbonActivado extends Fragment implements ObservacionItem {
    //AlertDialog
    ...
    //Metodo ArrayList
    LoteCarbonActivoAdacter Adapter;
    ArrayList<LoteCarbonActivadoClass> VersionNLote;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_carbon_activado, container, false);
    }
    ...
    private void processBuscar(String s) {
        ArrayList<LoteCarbonActivadoClass> milista = new ArrayList<>();
        for (LoteCarbonActivadoClass obj : VersionNLote) {
            if (obj.getNroloteCarbonActivado().toLowerCase().contains(s.toLowerCase())) {
                milista.add(obj);
            } else if (obj.getFechayhora().toLowerCase().contains(s.toLowerCase())) {
                milista.add(obj);
            }
        }
        LoteCarbonActivoAdacter adacter = new LoteCarbonActivoAdacter(milista);
        recyclerView.setAdapter(adacter);

        adacter.setmListener(new LoteCarbonActivoAdacter.ItemClickListener() {
            @Override
            public void onDeleteItem(LoteCarbonActivadoClass LoteCarbonActivadoClass) {
                InserDelete(LoteCarbonActivadoClass);
            }

            @Override
            public void onEditItem(LoteCarbonActivadoClass LoteCarbonActivadoClass) {
                inserEdit(LoteCarbonActivadoClass);
            }
        });
    }
        ...
        new SweetAlertDialog(getContext(), SweetAlertDialog.WARNING_TYPE)
                ...
                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    ...
                    public void onClick(SweetAlertDialog sDialog) {
                        VersionNLote.clear();
                        databaseReference.child("LotesCarbonActivado").removeValue();
    ...
    private void BottonesAdapter() {
        Adapter.setmListener(new LoteCarbonActivoAdacter.ItemClickListener() {
            @Override
            public void onDeleteItem(LoteCarbonActivadoClass LoteCarbonActivadoClass) {
                InserDelete(LoteCarbonActivadoClass);
            }
    ...
    private void inserEdit(LoteCarbonActivadoClass loteCarbonActivadoClass) {
        ...
        edtNroLote.setText(loteCarbonActivadoClass.getNroloteCarbonActivado());
        ...
        dialog.setTitle("Editar Lote Carbon Activado");
        dialog.show();
        ...
        btnGenerar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (NLote.equalsIgnoreCase("")) {
                    ...
                    //datos Lotes
                    LoteCarbonActivadoClass p = new LoteCarbonActivadoClass();
                    p.setId(loteCarbonActivadoClass.getId());
                    p.setNroloteCarbonActivado(edtNroLote.getText().toString().trim());
                    p.setFechayhora(loteCarbonActivadoClass.getFechayhora());
                    databaseReference.child("LotesCarbonActivado").child(p.getId()).setValue(p);
    ...
    private void InserDelete(LoteCarbonActivadoClass loteCarbonActivadoClass) {
        new SweetAlertDialog(getContext(), SweetAlertDialog.ERROR_TYPE)
                ...
                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    ...
                    public void onClick(SweetAlertDialog sDialog) {
                        LoteCarbonActivadoClass p = new LoteCarbonActivadoClass();
                        p.setId(loteCarbonActivadoClass.getId());
                        databaseReference.child("LotesCarbonActivado").child(p.getId()).removeValue();
            ...
            databaseReference.child("LotesCarbonActivado").addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        LoteCarbonActivadoClass loteCarbonActivadoClass = dataSnapshot.getValue(LoteCarbonActivadoClass.class);
                        VersionNLote.add(loteCarbonActivadoClass);
    ...
    private void InicioRecyclerview(View view) {
        ...
        //Adapter
        Adapter = new LoteCarbonActivoAdacter(VersionNLote);
    ...
    public void openDialog(View view) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogBuilder.setView(contactoPoupView);
                dialog = dialogBuilder.create();
                dialog.setTitle("Registro Lote Carbon Activado");
                dialog.show();
    ...
    private void inserccion() {
        ...
        String lote = "8021040479";
        //Datos de Lotes
        String nlote = edtNroLote.getText().toString();
        String key = databaseReference.push().getKey();
        LoteCarbonActivadoClass c = new LoteCarbonActivadoClass();
        c.setId(key);
        c.setNroloteCarbonActivado(nlote);
        c.setFechayhora(Date);
        databaseReference.child("LotesCarbonActivado").child(key).setValue(c);
    }
