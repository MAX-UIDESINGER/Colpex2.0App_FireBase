...
public class LoteAdacter extends RecyclerView.Adapter<LoteAdacter.versionVH> {

    ArrayList<Lote> LoteList;
    private ItemClickListener lListener;

    public LoteAdacter(ArrayList<Lote> versionList) {
    ...
    public versionVH onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_observacion, parent, false);
    ...
    public void onBindViewHolder(versionVH holder, int position) {
        ...
        if (Objects.equals(areaTrabajo, "Jefe General")) {
            ...
            holder.txtMensaje.setVisibility(View.INVISIBLE);
    ...
    public class versionVH extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TextView DatosLote, NLote, Producto, Cliente, Tonelaje, Fecha, NBatch, AcidoFosforico,
                TemTrabajo, Tresidencia, Descripcion, AreaTrabajo;
        ImageView userImage;
        //usuario
        TextView Nombre,txtMensaje;
