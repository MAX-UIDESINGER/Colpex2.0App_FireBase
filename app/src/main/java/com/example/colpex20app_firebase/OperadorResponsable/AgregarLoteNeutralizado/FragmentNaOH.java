package com.example.colpex20app_firebase.OperadorResponsable.AgregarLoteNeutralizado;
...
import com.example.colpex20app_firebase.Adactadores.Adacter_Operador.AdacterLote.LoteNaOHAdacter;
...
public class FragmentNaOH extends Fragment implements ObservacionItem {
    //AlertDialog
    ...
    //Metodo ArrayList
    LoteNaOHAdacter Adapter;
    ArrayList<LoteNaOHClass> VersionNLote;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_na_o_h, container, false);
    }
    ...
    private void processBuscar(String s) {
        ArrayList<LoteNaOHClass> milista = new ArrayList<>();
        for (LoteNaOHClass obj : VersionNLote) {
            if (obj.getNroloteNaOH().toLowerCase().contains(s.toLowerCase())) {
                milista.add(obj);
            } else if (obj.getFechayhora().toLowerCase().contains(s.toLowerCase())) {
                milista.add(obj);
            }
        }
        LoteNaOHAdacter adacter = new LoteNaOHAdacter(milista);
        recyclerView.setAdapter(adacter);
        adacter.setmListener(new LoteNaOHAdacter.ItemClickListener() {
            @Override
            public void onDeleteItem(LoteNaOHClass LoteNaOHClass) {
                InserDelete(LoteNaOHClass);
            }

            @Override
            public void onEditItem(LoteNaOHClass LoteNaOHClass) {
                inserEdit(LoteNaOHClass);
            }
        });
    }
        ...
        new SweetAlertDialog(getContext(), SweetAlertDialog.WARNING_TYPE)
                ...
                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    ...
                    public void onClick(SweetAlertDialog sDialog) {
                        VersionNLote.clear();
                        databaseReference.child("LotesNaOH").removeValue();
    ...
    private void BottonesAdapter() {
        Adapter.setmListener(new LoteNaOHAdacter.ItemClickListener() {
            @Override
            public void onDeleteItem(LoteNaOHClass LoteNaOHClass) {
                InserDelete(LoteNaOHClass);
            }
    ...
    private void inserEdit(LoteNaOHClass loteNaOHClass) {
        ...
        edtNroLote.setText(loteNaOHClass.getNroloteNaOH());
        ...
        dialog.setTitle("Editar Lote NaOH");
        dialog.show();
        ...
        btnGenerar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (NLote.equalsIgnoreCase("")) {
                    ...
                    //datos Lotes
                    LoteNaOHClass n = new LoteNaOHClass();
                    n.setId(loteNaOHClass.getId());
                    n.setNroloteNaOH(edtNroLote.getText().toString().trim());
                    n.setFechayhora(loteNaOHClass.getFechayhora());
                    databaseReference.child("LotesNaOH").child(n.getId()).setValue(n);
    ...
    private void InserDelete(LoteNaOHClass loteNaOHClass) {
        new SweetAlertDialog(getContext(), SweetAlertDialog.ERROR_TYPE)
                ...
                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    ...
                    public void onClick(SweetAlertDialog sDialog) {
                        LoteNaOHClass n = new LoteNaOHClass();
                        n.setId(loteNaOHClass.getId());
                        databaseReference.child("LotesNaOH").child(n.getId()).removeValue();
            ...
            databaseReference.child("LotesNaOH").addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        LoteNaOHClass loteNaOHClass = dataSnapshot.getValue(LoteNaOHClass.class);
                        VersionNLote.add(loteNaOHClass);
    ...
    private void InicioRecyclerview(View view) {
        ...
        //Adapter
        Adapter = new LoteNaOHAdacter(VersionNLote);
    ...
    public void openDialog(View view) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogBuilder.setView(contactoPoupView);
                dialog = dialogBuilder.create();
                dialog.setTitle("Registro Lote NaOH");
                dialog.show();
    ...
    private void inserccion() {
        ...
        LoteNaOHClass n = new LoteNaOHClass();
        n.setId(key);
        n.setNroloteNaOH("PT " + "- " + nlote);
        n.setFechayhora(Date);
        databaseReference.child("LotesNaOH").child(key).setValue(n);
    }
