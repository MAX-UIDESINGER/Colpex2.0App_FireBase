...
public class BlanqueadoAdacter_Jefe extends RecyclerView.Adapter<BlanqueadoAdacter_Jefe.versionVH> {

    ArrayList<ClaseBlanqueado> BlanqueadoList;
    private final RvItemClick rvItemClick;
    ArrayList<ClaseBlanqueado> VersionList;

    public BlanqueadoAdacter_Jefe(ArrayList<ClaseBlanqueado> blanqueadoList, RvItemClick rvItemClick) {
        BlanqueadoList = blanqueadoList;
    ...
    public versionVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_blanqueado_jefe, parent, false);
        return new versionVH(view);
    }

    @Override
    public void onBindViewHolder(@NonNull versionVH holder, int position) {
        ClaseBlanqueado blanqueado = BlanqueadoList.get(position);
        ...
        //Expandir panel
      boolean isExpandable = BlanqueadoList.get(position).isExpandable();
             ...
             linearLayout.setOnClickListener(new View.OnClickListener() {
               @Override
                 public void onClick(View view) {
                  ...
                  ClaseBlanqueado version = BlanqueadoList.get(getAdapterPosition());
